...
/** Base directory of data folder */
  ...
  * @param {str} string - string to append to the file.
  */
 ...
 * @param {logId} string source file name
 * @param {newFileId} string destination file name (zip file)
 */
 ...
 * @param {fileId} string - name of the file.
 */
...
/**
 * Truncate a log file.
 * @param {logId} string - name of the log file.
 */
